...
my_ssm_model.fit(train_transformed, future_covariates=covariates_transformed, verbose=True)
...
eval_model(my_ssm_model, 24, series_transformed, val_transformed)
# %%
